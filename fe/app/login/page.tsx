          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="block w-full px-4 py-3 pr-12 border border-slate-600 bg-slate-700 rounded-lg placeholder-slate-400 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                placeholder="••••••••"
              />
              <button
                type="button"
